...
paths = {
  ...
  "Bond Street Underground Station": [
    ...
    StationPath([(1000025,2),(1000025,15),(1000025,4)],[505],[528]), # CenEB -> JubNB
    StationPath([(1000025,2),(1000025,15),(1000025,5)],[506],[535]), # CenEB -> JubSB
    StationPath([(1000025,28),(1000025,15),(1000025,4)],[517],[529]), # CenWB -> JubNB
    StationPath([(1000025,28),(1000025,15),(1000025,5)],[518],[536]), # CenWB -> JubSB
