...
paths = {
  ...
  "Baker Street Underground Station": [
    StationPath([(1000011,12),(1000011,13),(1000011,19),(1000011,7)],[],[]), # Entrance1 -> JubNB
    StationPath([(1000011,12),(1000011,13),(1000011,19),(1000011,6)],[],[]), # Entrance1 -> JubSB
    
    StationPath([(1000011,16),(1000011,13),(1000011,19),(1000011,7)],[]), # Entrance2 (Rail) -> JubNB
    StationPath([(1000011,16),(1000011,13),(1000011,19),(1000011,6)],[]), # Entrance2 (Rail) -> JubSB

    StationPath([(1000011,7),(1000011,19),(1000011,3)],[],[]), # JubNB -> BakNB
    StationPath([(1000011,7),(1000011,19),(1000011,2)],[],[]), # JubNB -> BakSB
    StationPath([(1000011,6),(1000011,19),(1000011,3)],[],[]), # JubSB -> BakNB
    StationPath([(1000011,6),(1000011,19),(1000011,2)],[],[]), # JubSB -> BakSB

    StationPath([(1000011,7),(1000011,19),(1000011,9)],[],[]), # JubNB -> MetEB
    StationPath([(1000011,7),(1000011,19),(1000011,8)],[],[]), # JubNB -> MetWB
    StationPath([(1000011,6),(1000011,19),(1000011,9)],[],[]), # JubSB -> MetEB
    StationPath([(1000011,6),(1000011,19),(1000011,8)],[],[]), # JubSB -> MetWB
